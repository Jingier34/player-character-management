...
//		if (column.equals("name") || column.equals("player") || column.equals("job") || column.equals("hp")
//				|| column.equals("level")) {
//			return column;
//		}
//		return null;
...
//					@Override
//					public int compare(CharacterInfo c1, CharacterInfo c2) {
//						return sortOrder.equals("DESC") ? Integer.compare(c2.getMaxHP(), c1.getMaxHP())
...
//						if (job1 == null || job2 == null)
//							return 0;
//						return sortOrder.equals("DESC") ? Integer.compare(job2.getLevel(), job1.getLevel())
...
public class FindPlayers extends HttpServlet {
    ...
    private String validateSortColumn(String sortBy) {
        ...
        String column = sortBy.toLowerCase().trim();
        if (column.equals("name") || column.equals("player") || column.equals("job") || column.equals("hp")
                || column.equals("level") || column.equals("exp")) {  
            return column;
        }
        return null;
    }
                ...
                Collections.sort(characters, new Comparator<CharacterInfo>() {
                    ...
                    public int compare(CharacterInfo c1, CharacterInfo c2) {
                        ...
                        if (job1 == null || job2 == null)
                            return 0;
                        return sortOrder.equals("DESC") 
                                ? Integer.compare(job2.getExperiencePoints(), job1.getExperiencePoints())
                                : Integer.compare(job1.getExperiencePoints(), job2.getExperiencePoints());
                    }
                });
            }
        }
