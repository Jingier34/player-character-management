...
import pm4.dal.AttributesDao;
import pm4.dal.CharacterAttributesDao;
import pm4.dal.CharacterCurrenciesDao;
import pm4.dal.CharacterEquipmentsDao;
import pm4.dal.CharacterInfoDao;
import pm4.dal.CharacterJobsDao;
import pm4.dal.ConsumableAttributesDao;
import pm4.dal.ConsumablesDao;
import pm4.dal.CurrenciesDao;
import pm4.dal.EquipmentSlotsDao;
import pm4.dal.EquippableItemsDao;
import pm4.dal.GearAndWeaponAttributesDao;
import pm4.dal.GearAndWeaponJobsDao;
import pm4.dal.GearsDao;
import pm4.dal.InventoryPositionsDao;
import pm4.dal.ItemsDao;
import pm4.dal.JobsDao;
import pm4.dal.PlayersDao;
import pm4.dal.WeaponsDao;
import pm4.model.Attributes;
import pm4.model.CharacterAttributes;
import pm4.model.CharacterCurrencies;
import pm4.model.CharacterEquipments;
import pm4.model.CharacterInfo;
import pm4.model.CharacterJobs;
import pm4.model.ConsumableAttributes;
import pm4.model.Consumables;
import pm4.model.Currencies;
import pm4.model.EquippableItems;
import pm4.model.GearAndWeaponAttributes;
import pm4.model.GearAndWeaponJobs;
import pm4.model.Gears;
import pm4.model.InventoryPositions;
import pm4.model.Items;
import pm4.model.Jobs;
import pm4.model.EquipmentSlots;
import pm4.model.Players;
import pm4.model.Weapons;
...
public class Driver {
    ...
    private static void testPlayerAndCharacters() throws SQLException {
        ...
        try {
            ...
            // Create a characterEquipment: insert equipment for the character using the
            // existing slotID and itemID
            ...
            CharacterInfo retrievedCharacter = characterInfoDao
                    .getCharactersByCharacterID(newCharacter.getCharacterID());
            ...
            // Update equipment by using another existing item in EquippableItems (e.g.,
            // itemID 2)
    ...
    private static void testCharacterAttributes() throws SQLException {
        ...
        try {
            ...
            List<CharacterAttributes> attributes = characterAttributesDao
                    .getCharacterAttributes(character.getCharacterID());
            for (CharacterAttributes ca : attributes) {
                System.out.println(
                        "Attribute: " + ca.getAttributes().getAttributeName() + " = " + ca.getAttributeValue());
            }
            ...
            for (InventoryPositions ip : inventory) {
                System.out
                        .println("Inventory: " + ip.getItems().getItemName() + " at position " + ip.getStackPosition());
            }
    ...
    private static void testGearAndWeapon() throws SQLException {
        ...
        System.out.println(
                "TABLE ConsumableAttributes: create, getConsumableAttributeByItemIdAndAttributeId, getAttributesByItemId, updateConsumableAttribute");
        System.out.println(
                "TABLE Consumables: create, getConsumableByItemID, updateConsumable, updateDescription, getConsumablesByItemLevel, delete");
        ...
        try {
            ...
            System.out
                    .println("Main hand slot: " + (savedMainHandSlot != null ? savedMainHandSlot.getSlotID() : "null"));
            ...
            ConsumableAttributes retrievedEffect = consumableAttributesDao
                    .getConsumableAttributeByItemIdAndAttributeId(savedPotion.getItemID(),
                            savedStrength.getAttributeID());
            System.out.println("Retrieved consumable attribute");

            List<ConsumableAttributes> attributesList = consumableAttributesDao
                    .getAttributesByItemId(savedPotion.getItemID());
            ...
            GearAndWeaponAttributes retrievedGearAndWeaponAttributes = gearAndWeaponAttributesDao
                    .getGearAttributeByIds(savedSword.getItemID(), savedStrength.getAttributeID());
